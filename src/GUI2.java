...
public class GUI2 extends javax.swing.JFrame {
    ...
    private void submitButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_submitButtonActionPerformed
        ...
        try {
            ...
            insert.setString(2,js.getJob());
            insert.setDate(3,js.getDateSql());
            insert.setInt(4,js.getId());
            insert.executeUpdate();
            JOptionPane.showMessageDialog(this, "Congratulations " +js.getFirstName()+ " you succcessfuly applied for this job");
