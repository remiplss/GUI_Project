...
public interface JobSeekerDAO 
{
   ...
   ///Method which add an employer to the jobSeekerList talble in the Db
    public void addJobSeekerToList(JobSeeker js);
    ///Methode which diplay all the descriptions according to the job
   ...
   ///methode which returns the id of the Job from the db$
